...
/**
 * L�sst neue Ressourcen dynamisch laden
 */
public class RessourceManager {
	...
	/**
	 * L�dt ein Bild aus einer Datei oder dem Speicher
	 * 
	 * @param name
	...
	/**
	 * L�dt eine XML-Datei aus dem Speicher
	 * 
	 * @param name
	...
	/**
	 * L�dt ein Bild aus einem Tilesheet aus einer Datei oder dem Speicher
	 * 
	 * @param tilesheetname
	 * @param x
	 * @param y
	...
	/**
	 * L�dt einen Sound aus einer Datei oder dem Speicher
	 * 
	 * @param name
